...
<body class="bg-silver-300">
    <div class="content">
        <form id="login-form" class="mt-4" action="<?= base_url('login') ?>" method="post">
            <div class="text-center mb-4">
                <img src="<?php base_url() ?>assets/frontend/images/logo.jpg" class="img-thumbnail mb-2"
                    style="max-width: 80px ;">
                <h3>PT Indo Sulaiman Makmur</h3>
            </div>
            ...
            <div class="form-group">
                ...
                <a class="btn btn-success btn-block" href="<?= base_url() ?>">Back To Website</a>
            </div>
        </form>
    </div>
    ...
    <!-- PAGE LEVEL PLUGINS -->
    <script src="<?= base_url() ?>assets/vendors/jquery-validation/dist/jquery.validate.min.js" type="text/javascript">
    </script>
    <!-- CORE SCRIPTS-->
