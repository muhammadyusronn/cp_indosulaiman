<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">Formulir Admin</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php"><i class="fa fa-home font-20"></i></a>
            </li>
            <li class="breadcrumb-item">Formulir Admin</li>
        </ol>
    </div>
            ...
            <div class="ibox-body">
                ...
                <form class="form-horizontal" id="form-admin" method="post" action="<?= $url ?>" novalidate="novalidate">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="<?= isset($user) ? $user[0]->username : '' ?>" name="username">
